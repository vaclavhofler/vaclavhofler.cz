		...
		// skel
			skel: {
				...
				breakpoints: {
					...
					'mobile': { range: '-740', containers: '95%', grid: { gutters: 20 }, lockViewport: true },
										...
										// Generic sections
											...
											$('#one')
												.scrollwatch({
													...
													on:			function(t) {
														t.removeClass('inactive');
														$telo.addClass('kdojsem');
													},
													off:		function(t) {
														t.addClass('inactive');
														$telo.removeClass('kdojsem');
													}
												});
												...
												$('#two')
													.scrollwatch({
														...
														on:			function(t) {
															t.removeClass('inactive');
															$telo.addClass('codelam');
														},
														off:		function(t) {
															t.addClass('inactive');
															$telo.removeClass('codelam');
														}
													});
										...
										// Contact
											$('#contact')
												.scrollwatch({
													...
													on:			function(t) {
														t.removeClass('inactive');
														$telo.addClass('kontakt');
													},
													off:		function(t) {
														t.addClass('inactive');
														$telo.removeClass('kontakt');
													}
												});
